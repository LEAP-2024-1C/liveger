...
function Day({
	...
	return (
		<div
			className={`day h-32 sm:h-28 md:h-32 w-full flex flex-col border border-green-400 items-center justify-between rounded-lg ${
			...
			<div className="flex w-full items-center justify-center">
				{guestsPhoto ? (
					...
					<div>
						...
						<div
							className={`  ${
								isHostBlocked ? " bg-red-400 p-3 rounded-full sm:hidden" : ""
							}`}
						></div>
					</div>
				) : (
